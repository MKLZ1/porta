...
function agregarHojasSprites(){
    ...
    agregarHojaSprites("KR_T1_muerte","recursos/KRcaida.png",64,64);
    agregarHojaSprites("KR_T1_T2","recursos/KRB.png",64,64);

    agregarHojaSprites("fast_t1_basico","recursos/rapid.png",128,128);
    agregarHojaSprites("horo_durmiendo","recursos/horoDurmiendo.png",416,288);
