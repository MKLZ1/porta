...
class Laser {
  ...
  objetivoCriatura;
  // point;
  constructor(x, y, objetivoCriatura) {
    this.x = x;
    this.y = y;
    cargarImagen("recursos/laserRojo.png").then((imagen) => {
      Laser.imagen = imagen;
    });
    this.objetivoCriatura = objetivoCriatura;

    let dx = this.objetivoCriatura.getX() - this.x;
    let dy = this.objetivoCriatura.getY() - this.y;
    ...
    this.colision = new Rectangulo(x, y, 32, 32);
