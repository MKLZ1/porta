...
function cargarAnimaciones() {
  ...
  animaciones.set("fast_t1_basico_moviendose",fast_t1_basico_moviendose);
   ...
   let horo_durmiendo = new Animador(getHojaSprites("horo_durmiendo"),38);
   horo_durmiendo.setAnimacion(2, [0,1,2,3]);
   horo_durmiendo.setAnimacion(6, [0,1,2,3]);
   horo_durmiendo.setAnimacion(0, [0,1,2,3]);
   horo_durmiendo.setAnimacion(4, [0,1,2,3]);
   animaciones.set("horo_durmiendo",horo_durmiendo);
